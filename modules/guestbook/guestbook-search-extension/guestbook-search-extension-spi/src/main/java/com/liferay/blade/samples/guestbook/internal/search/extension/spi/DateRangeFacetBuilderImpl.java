...
@Component(immediate = true, service = DateRangeFacetBuilder.class)
public class DateRangeFacetBuilderImpl implements DateRangeFacetBuilder {

	@Override
	public DateRangeFacet build() {
		DateRangeFacet dateRangeFacet = new DateRangeFacetImpl(
	_fieldName, _searchContext, _filterBuilders);
	...
	@Override
	public DateRangeFacetBuilder setFilterBuilders(
